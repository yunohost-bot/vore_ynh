...
[![集成程度](https://dash.yunohost.org/integration/vore.svg)](https://ci-apps.yunohost.org/ci/apps/vore/) ![工作状态](https://ci-apps.yunohost.org/ci/badges/vore.status.svg) ![维护状态](https://ci-apps.yunohost.org/ci/badges/vore.maintain.svg)
